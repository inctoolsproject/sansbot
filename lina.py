...
cl = LineAlpha.LINE()
cl.login(token='EjeViEJ8yCmwm401u8h6.6IbVQCfMoW2xvkuVc2AYjG.2fysz4PCN7oOPuxWnLWhVD68lfyS6mQqOY7X/VEC6ds=')
cl.loginResult()
...
Bots=[mid]
admin=["u48d3745b1e5e149de00b8e993cc9a19a"]
wait = {
    'contact':True,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
               ...
               if wait["wblack"] == True:
            ...
            elif "Lina kick " in msg.text:
                midd = msg.text.replace("Lina kicked ","")
                cl.kickoutFromGroup(msg.to,[midd])
            elif "Lina invite " in msg.text:
                midd = msg.text.replace("Lina invite ","")
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
            elif msg.text in ["Lina"]:
                msg.contentType = 13
                msg.contentMetadata = {'Hallo Sayang': mid}
                cl.sendMessage(msg)
            ...
            elif msg.text in ["Lina cancel","Bot cancel"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Lina ourl","Lina link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done Lina")
                    else:
                        cl.sendText(msg.to,"already open")
                else:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Lina rename "]:
                string = msg.text.replace("Lina rename ","")
                if len(string.decode('utf-8')) <= 20:
...
#-----------------------------------------------
            ...
            elif msg.text in ["lina say hi"]:
                cl.sendText(msg.to,"Hi boss, udah makan, udah mandi, udah nenen.?")

#-----------------------------------------------

            elif msg.text in ["asu"]:
                cl.sendText(msg.to,"Bangsat")
...
#------------------------------------------------------------------
            ...
            elif "kondom:" in msg.text:
              if msg.from_ in admin:
                if msg.toType == 2:
                    strnum = msg.text.replace("kondom:","")
